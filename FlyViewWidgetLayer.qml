...
Item {
    ...
    Video {
        ...
        anchors.left:       parent.left
        anchors.right:      parent.right
        anchors.bottom:     camOverlay.top
        source:             "file:///media/prudhvi/Skyeris/qgc-dev/qgroundcontrol/Video Sample/clideo_editor_629b23262e4c42f682a7b4e771d996c6.mp4"
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            anchors.rightMargin:    ScreenTools.defaultFontPixelWidth
            QGCLabel {
                text:           qsTr("AI Intelligence Feed")
                color:          "#00B894"
